...
document.getElementById('contactForm')?.addEventListener('submit',e=>{e.preventDefault();const note=document.getElementById('formNote');note.textContent='Thank you. Your enquiry form is working in demo mode; connect it to email or a backend before launch.';note.style.color='#159a91';});
